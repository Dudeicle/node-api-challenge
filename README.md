...
- [ ] Mention two parts of Express that you learned about this week.
      ...
      Two parts of Express that I learned this week were, Express is a module of Node.js, and it’s Middleware/Routing. Middleware is essentially a function that can change the request or response and routing is similar to how it works from React-Router-dom in the sense that the app can be broken down based on the URL path.

- [ ] Describe Middleware?

      Middleware is essentially a function that can change the request or response

- [ ] Describe a Resource?

      A resource is any set of information on the database such as the array of users

- [ ] What can the API return to help clients know if a request was successful?

      The API can return a 200 OK signal to let the clients know that a request was successful or a logger middleware as a more user friendly way to communicate with the user.

- [ ] How can we partition our application into sub-applications?

      We can partition our application using Routing
